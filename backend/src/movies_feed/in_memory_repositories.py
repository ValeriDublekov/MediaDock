...
class InMemoryTitleRepository(TitleRepository):
...
class InMemoryOmdbCacheRepository(OmdbCacheRepository):
    def __init__(self) -> None:
...
class InMemoryScanRunRepository(ScanRunRepository):
    def __init__(self) -> None:
...
class InMemoryRssSnapshotRepository(RssSnapshotRepository):
    def __init__(self) -> None:
...
class InMemoryParseLogRepository(ParseLogRepository):
    def __init__(self) -> None:
...
class InMemoryManualMappingRepository(ManualMappingRepository):
    def __init__(self) -> None:
...
class InMemoryAuditProposalRepository(AuditProposalRepository):
    def __init__(self) -> None:
